...
exports.getMonthlyDetailHandler = getMonthlyDetailHandler;
exports.getDailyAggregations = getDailyAggregations;
...
async function getDashboardSummary(req, res) {
    try {
        ...
        const summary = await (0, aggregationService_1.getSummary)(Object.keys(filters).length > 0 ? filters : undefined);
        res.json({
            ok: true,
            data: summary,
...
async function getDashboardMonthly(req, res) {
    try {
        ...
        const breakdown = await (0, aggregationService_1.getMonthlyBreakdown)(safeMonths);
        res.json({
            ok: true,
            data: breakdown,
            months: safeMonths,
...
async function listTransactions(req, res) {
    try {
        ...
        const [total, items] = await Promise.all([
            prisma_1.prisma.eventProcessed.count({ where }),
 ...
 */
async function getMonthlyDetailHandler(req, res) {
    try {
        ...
        const detail = await (0, aggregationService_1.getMonthlyDetail)(month);
 ...
 */
async function getDailyAggregations(req, res) {
    try {
        ...
        const rows = await prisma_1.prisma.dailyAggregation.findMany({
            where: {
